...
console.log("Alumnos en la escuela:", escuela.getAlumnos().map(alumno => alumno.getNombre()));

// Desvincular un alumnos de la escuela 
escuela.expulsarAlumno("Juan");
console.log("Alumnos después de expulsar a Juan:", escuela.getAlumnos().map(alumno => alumno.getNombre()));

// Despedir a un profesor
escuela.despedirProfesor("Profe Karen");
console.log("Profes después de despedir a Karen:", escuela.getProfesores().map(profesor => profesor.getNombre()));